...
database_name = case Padrino.env
  when :development then 'clasesenvivo_development'
  when :production  then 'clasesenvivo_production'
  when :test        then 'clasesenvivo_test'
end
...
#     sessions:
#       default:
#         database: clasesenvivo_development
#         hosts:
#           - localhost:27017
#   production:
#     sessions:
#       default:
#         database: clasesenvivo_production
#         hosts:
#           - localhost:27017
#   test:
#     sessions:
#       default:
#         database: clasesenvivo_test
#         hosts:
#           - localhost:27017
#
#
